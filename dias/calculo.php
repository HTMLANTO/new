...
<head>
  ...
  <link rel="shortcut icon" href="../img/calculador.png " />

  <title>Dias de Creditos</title>
  <!-- Bootstrap core CSS -->
...
<body >
  ...
  <header>
    ...
    <nav class="navbar navbar-expand-md navbar-dark fixed-top bg-dark">
      <a class="navbar-brand" href="http://localhost/cobranza/">Home</a>
      ...
      <div class="collapse navbar-collapse" id="navbarCollapse">
        <ul class="navbar-nav mr-auto">
          <li class="nav-item active">
            <a class="nav-link" href="http://localhost/cobranza/"> <span class="sr-only">(current)</span></a>
          </li>
  ...
  <div class="container" >
    <h1 class="text-center col-md-6" class="mt-4" >Dias de Creditos</h1>
    ...
    <div class="row">
      <div class="col-12 col-md-6">
        ...
        <form method="POST" action="" class="text-center">
          ...
          <input  class="btn btn-warning" type="submit" value="Calcular ">
        </form>
